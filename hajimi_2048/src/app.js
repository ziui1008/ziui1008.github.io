(function () {
  ...
  function bindEvents() {
    ...
    elements.continueButton.addEventListener("click", () => {
      const game = activeGame();
      playActionSound();
      // The win overlay can be clicked while the final move animation is still settling.
      // Clear any transient input lock so continuing always returns control to the board.
      busy = false;
      queuedDirection = null;
      game.status = "playing";
      saveState();
